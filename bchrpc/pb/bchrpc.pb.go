...
const (
	...
	// OP_GROUP related
	SlpTokenType_VX_GROUP SlpTokenType = 10
)
...
const (
	...
	// SLP_OUTPUTS will only be used within the SlpTransactionInfo message
	// if multiple slp actions within the same transaction.
	SlpAction_SLP_OUTPUTS SlpAction = 13
	// OP_GROUP related actions
	SlpAction_SLP_X_GROUP_GENESIS          SlpAction = 14
	SlpAction_SLP_X_GROUP_SUBGROUP_GENESIS SlpAction = 15
	SlpAction_SLP_X_GROUP_SEND_OUTPUT      SlpAction = 16
	SlpAction_SLP_X_GROUP_MINT_OUTPUT      SlpAction = 17
	SlpAction_SLP_X_GROUP_MELT_INPUT       SlpAction = 18
	SlpAction_SLP_X_GROUP_RESCRIPT         SlpAction = 19
	SlpAction_SLP_X_GROUP_AUTHORITY_OUTPUT SlpAction = 20
)
...
var (
	SlpAction_name = map[int32]string{
		...
		13: "SLP_OUTPUTS",
		14: "SLP_X_GROUP_GENESIS",
		15: "SLP_X_GROUP_SUBGROUP_GENESIS",
		16: "SLP_X_GROUP_SEND_OUTPUT",
		17: "SLP_X_GROUP_MINT_OUTPUT",
		18: "SLP_X_GROUP_MELT_INPUT",
		19: "SLP_X_GROUP_RESCRIPT",
		20: "SLP_X_GROUP_AUTHORITY_OUTPUT",
	}
	SlpAction_value = map[string]int32{
		...
		"SLP_OUTPUTS":                      13,
		"SLP_X_GROUP_GENESIS":              14,
		"SLP_X_GROUP_SUBGROUP_GENESIS":     15,
		"SLP_X_GROUP_SEND_OUTPUT":          16,
		"SLP_X_GROUP_MINT_OUTPUT":          17,
		"SLP_X_GROUP_MELT_INPUT":           18,
		"SLP_X_GROUP_RESCRIPT":             19,
		"SLP_X_GROUP_AUTHORITY_OUTPUT":     20,
	}
)
...
// AuthorityFlags represents the authority flags in an authority output
// The enum values are not the protocol flag values.
type AuthorityFlag int32

const (
	AuthorityFlag_MINT     AuthorityFlag = 0
	AuthorityFlag_MELT     AuthorityFlag = 1
	AuthorityFlag_BATON    AuthorityFlag = 2
	AuthorityFlag_RESCRIPT AuthorityFlag = 3
	AuthorityFlag_SUBGROUP AuthorityFlag = 4
)

// Enum value maps for AuthorityFlag.
var (
	AuthorityFlag_name = map[int32]string{
		0: "MINT",
		1: "MELT",
		2: "BATON",
		3: "RESCRIPT",
	...
	AuthorityFlag_value = map[string]int32{
		"MINT":     0,
		"MELT":     1,
		"BATON":    2,
		"RESCRIPT": 3,
...
func (x AuthorityFlag) Enum() *AuthorityFlag {
	p := new(AuthorityFlag)
	*p = x
	return p
}

func (x AuthorityFlag) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AuthorityFlag) Descriptor() protoreflect.EnumDescriptor {
	return file_bchrpc_proto_enumTypes[3].Descriptor()
}

func (AuthorityFlag) Type() protoreflect.EnumType {
	return &file_bchrpc_proto_enumTypes[3]
}

func (x AuthorityFlag) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use AuthorityFlag.Descriptor instead.
func (AuthorityFlag) EnumDescriptor() ([]byte, []int) {
...
func (x *SlpTokenMetadata) GetVxGroup() *SlpTokenMetadata_VxGroup {
	if x, ok := x.GetTypeMetadata().(*SlpTokenMetadata_VxGroup_); ok {
		return x.VxGroup
	}
	return nil
}
...
type SlpTokenMetadata_VxGroup_ struct {
	// OP_GROUP type of metadata
	VxGroup *SlpTokenMetadata_VxGroup `protobuf:"bytes,6,opt,name=vx_group,json=vxGroup,proto3,oneof"`
}
...
func (*SlpTokenMetadata_VxGroup_) isSlpTokenMetadata_TypeMetadata() {}
...
// VxGroup is used to marshal metadata specific to OP_GROUP version of SLP
type SlpTokenMetadata_VxGroup struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SlpTokenMetadata_VxGroup) Reset() {
	*x = SlpTokenMetadata_VxGroup{}
	if protoimpl.UnsafeEnabled {
...
func (x *SlpTokenMetadata_VxGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SlpTokenMetadata_VxGroup) ProtoMessage() {}

func (x *SlpTokenMetadata_VxGroup) ProtoReflect() protoreflect.Message {
	mi := &file_bchrpc_proto_msgTypes[69]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SlpTokenMetadata_VxGroup.ProtoReflect.Descriptor instead.
func (*SlpTokenMetadata_VxGroup) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{57, 3}
}

func (x *SlpTokenMetadata_VxGroup) GetTokenTicker() string {
	if x != nil {
		return x.TokenTicker
	}
	return ""
...
func (x *SlpTokenMetadata_VxGroup) GetTokenName() string {
	if x != nil {
		return x.TokenName
	}
	return ""
...
func (x *SlpTokenMetadata_VxGroup) GetTokenDocumentUrl() string {
	if x != nil {
		return x.TokenDocumentUrl
	}
	return ""
...
func (x *SlpTokenMetadata_VxGroup) GetTokenDocumentHash() []byte {
	if x != nil {
		return x.TokenDocumentHash
	}
	return nil
...
func (x *SlpTokenMetadata_VxGroup) GetDecimals() uint32 {
	if x != nil {
		return x.Decimals
	}
	return 0
...
func (x *SlpTokenMetadata_VxGroup) GetParentGroupId() []byte {
	if x != nil {
...
func (x *SlpTokenMetadata_VxGroup) GetGroupFlags() []GroupFlag {
	if x != nil {
		return x.GroupFlags
	}
	return nil
...
var file_bchrpc_proto_rawDesc = []byte{
	...
	0x49, 0x64, 0x73, 0x22, 0xfa, 0x01, 0x0a, 0x08, 0x53, 0x6c, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	,
	...
	0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x6c, 0x70,
	...
	,
	...
	,
	...
	0x61, 0x6c, 0x73, 0x12, 0x24, 0x0a, 0x0e, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x64, 0x22, 0x42, 0x0a, 0x1a, 0x53, 0x6c, 0x70,
	0x56, 0x31, 0x4e, 0x66, 0x74, 0x31, 0x43, 0x68, 0x69, 0x6c, 0x64, 0x53, 0x65, 0x6e, 0x64, 0x4d,
	...
	0x0c, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x64, 0x22, 0xa0, 0x0b,
	0x0a, 0x10, 0x53, 0x6c, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x12, 0x19, 0x0a, 0x08, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x64, 0x12, 0x2f, 0x0a,
	...
	,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x1a,
	0x9d, 0x02, 0x0a, 0x07, 0x56, 0x78, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x21, 0x0a, 0x0c, 0x74,
	...
	0x65, 0x63, 0x69, 0x6d, 0x61, 0x6c, 0x73, 0x12, 0x26, 0x0a, 0x0f, 0x70, 0x61, 0x72, 0x65, 0x6e,
	0x74, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x0d, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x12,
	0x2e, 0x0a, 0x0b, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18, 0x07,
	0x20, 0x03, 0x28, 0x0e, 0x32, 0x0d, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x46,
	0x6c, 0x61, 0x67, 0x52, 0x0a, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x46, 0x6c, 0x61, 0x67, 0x73, 0x42,
	...
	0x65, 0x6e, 0x74, 0x69, 0x6f, 0x6e, 0x2a, 0x69, 0x0a, 0x0c, 0x53, 0x6c, 0x70, 0x54, 0x6f, 0x6b,
	...
	,
	...
	0x12, 0x58, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x53, 0x6c, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x1e, 0x2e, 0x70, 0x62, 0x2e, 0x47, 0x65, 0x74,
	0x53, 0x6c, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	...
	,
	...
	0x53, 0x6c, 0x70, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1e,
	0x2e, 0x70, 0x62, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x53, 0x6c, 0x70, 0x54, 0x72, 0x61, 0x6e,
	...
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x30, 0x01, 0x42, 0x30,
	0x0a, 0x0d, 0x63, 0x61, 0x73, 0x68, 0x2e, 0x62, 0x63, 0x68, 0x64, 0x2e, 0x72, 0x70, 0x63, 0x5a,
	0x1f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x63, 0x61, 0x73,
	0x68, 0x2f, 0x62, 0x63, 0x68, 0x64, 0x2f, 0x62, 0x63, 0x68, 0x72, 0x70, 0x63, 0x2f, 0x70, 0x62,
...
var file_bchrpc_proto_goTypes = []interface{}{
	...
	(AuthorityFlag)(0), // 3: pb.AuthorityFlag
	...
	(*SlpTokenMetadata_VxGroup)(nil),                       // 78: pb.SlpTokenMetadata.VxGroup
}
var file_bchrpc_proto_depIdxs = []int32{
	...
	7,  // 47: pb.SlpTransactionInfo.validity_judgement:type_name -> pb.SlpTransactionInfo.ValidityJudgement
	8,  // 48: pb.SlpTransactionInfo.burn_flags:type_name -> pb.SlpTransactionInfo.BurnFlags
	...
	78, // 58: pb.SlpTokenMetadata.vx_group:type_name -> pb.SlpTokenMetadata.VxGroup
	74, // 59: pb.SlpRequiredBurn.outpoint:type_name -> pb.Transaction.Input.Outpoint
	0,  // 60: pb.SlpRequiredBurn.token_type:type_name -> pb.SlpTokenType
	55, // 61: pb.GetMempoolResponse.TransactionData.transaction:type_name -> pb.Transaction
	1,  // 62: pb.GetSlpTrustedValidationResponse.ValidityResult.slp_action:type_name -> pb.SlpAction
	0,  // 63: pb.GetSlpTrustedValidationResponse.ValidityResult.token_type:type_name -> pb.SlpTokenType
	55, // 64: pb.Block.TransactionData.transaction:type_name -> pb.Transaction
	74, // 65: pb.Transaction.Input.outpoint:type_name -> pb.Transaction.Input.Outpoint
	59, // 66: pb.Transaction.Input.slp_token:type_name -> pb.SlpToken
	59, // 67: pb.Transaction.Output.slp_token:type_name -> pb.SlpToken
	2,  // 68: pb.SlpTokenMetadata.VxGroup.group_flags:type_name -> pb.GroupFlag
	9,  // 69: pb.bchrpc.GetMempoolInfo:input_type -> pb.GetMempoolInfoRequest
	11, // 70: pb.bchrpc.GetMempool:input_type -> pb.GetMempoolRequest
	13, // 71: pb.bchrpc.GetBlockchainInfo:input_type -> pb.GetBlockchainInfoRequest
	15, // 72: pb.bchrpc.GetBlockInfo:input_type -> pb.GetBlockInfoRequest
	17, // 73: pb.bchrpc.GetBlock:input_type -> pb.GetBlockRequest
	19, // 74: pb.bchrpc.GetRawBlock:input_type -> pb.GetRawBlockRequest
	21, // 75: pb.bchrpc.GetBlockFilter:input_type -> pb.GetBlockFilterRequest
	23, // 76: pb.bchrpc.GetHeaders:input_type -> pb.GetHeadersRequest
	25, // 77: pb.bchrpc.GetTransaction:input_type -> pb.GetTransactionRequest
	27, // 78: pb.bchrpc.GetRawTransaction:input_type -> pb.GetRawTransactionRequest
	29, // 79: pb.bchrpc.GetAddressTransactions:input_type -> pb.GetAddressTransactionsRequest
	31, // 80: pb.bchrpc.GetRawAddressTransactions:input_type -> pb.GetRawAddressTransactionsRequest
	33, // 81: pb.bchrpc.GetAddressUnspentOutputs:input_type -> pb.GetAddressUnspentOutputsRequest
	35, // 82: pb.bchrpc.GetUnspentOutput:input_type -> pb.GetUnspentOutputRequest
	37, // 83: pb.bchrpc.GetMerkleProof:input_type -> pb.GetMerkleProofRequest
	45, // 84: pb.bchrpc.GetSlpTokenMetadata:input_type -> pb.GetSlpTokenMetadataRequest
	47, // 85: pb.bchrpc.GetSlpParsedScript:input_type -> pb.GetSlpParsedScriptRequest
	49, // 86: pb.bchrpc.GetSlpTrustedValidation:input_type -> pb.GetSlpTrustedValidationRequest
	41, // 87: pb.bchrpc.CheckSlpTransaction:input_type -> pb.CheckSlpTransactionRequest
	39, // 88: pb.bchrpc.SubmitTransaction:input_type -> pb.SubmitTransactionRequest
	43, // 89: pb.bchrpc.SubscribeTransactions:input_type -> pb.SubscribeTransactionsRequest
	43, // 90: pb.bchrpc.SubscribeTransactionStream:input_type -> pb.SubscribeTransactionsRequest
	44, // 91: pb.bchrpc.SubscribeBlocks:input_type -> pb.SubscribeBlocksRequest
	10, // 92: pb.bchrpc.GetMempoolInfo:output_type -> pb.GetMempoolInfoResponse
	12, // 93: pb.bchrpc.GetMempool:output_type -> pb.GetMempoolResponse
	14, // 94: pb.bchrpc.GetBlockchainInfo:output_type -> pb.GetBlockchainInfoResponse
	16, // 95: pb.bchrpc.GetBlockInfo:output_type -> pb.GetBlockInfoResponse
	18, // 96: pb.bchrpc.GetBlock:output_type -> pb.GetBlockResponse
	20, // 97: pb.bchrpc.GetRawBlock:output_type -> pb.GetRawBlockResponse
	22, // 98: pb.bchrpc.GetBlockFilter:output_type -> pb.GetBlockFilterResponse
	24, // 99: pb.bchrpc.GetHeaders:output_type -> pb.GetHeadersResponse
	26, // 100: pb.bchrpc.GetTransaction:output_type -> pb.GetTransactionResponse
	28, // 101: pb.bchrpc.GetRawTransaction:output_type -> pb.GetRawTransactionResponse
	30, // 102: pb.bchrpc.GetAddressTransactions:output_type -> pb.GetAddressTransactionsResponse
	32, // 103: pb.bchrpc.GetRawAddressTransactions:output_type -> pb.GetRawAddressTransactionsResponse
	34, // 104: pb.bchrpc.GetAddressUnspentOutputs:output_type -> pb.GetAddressUnspentOutputsResponse
	36, // 105: pb.bchrpc.GetUnspentOutput:output_type -> pb.GetUnspentOutputResponse
	38, // 106: pb.bchrpc.GetMerkleProof:output_type -> pb.GetMerkleProofResponse
	46, // 107: pb.bchrpc.GetSlpTokenMetadata:output_type -> pb.GetSlpTokenMetadataResponse
	48, // 108: pb.bchrpc.GetSlpParsedScript:output_type -> pb.GetSlpParsedScriptResponse
	50, // 109: pb.bchrpc.GetSlpTrustedValidation:output_type -> pb.GetSlpTrustedValidationResponse
	42, // 110: pb.bchrpc.CheckSlpTransaction:output_type -> pb.CheckSlpTransactionResponse
	40, // 111: pb.bchrpc.SubmitTransaction:output_type -> pb.SubmitTransactionResponse
...
func file_bchrpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bchrpc_proto_msgTypes[69].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SlpTokenMetadata_VxGroup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
