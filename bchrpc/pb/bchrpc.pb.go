...
const (
	// this will be used with non-slp op_group outputs
	...
	// slp v2 type (op_group related)
	SlpTokenType_V2_GROUP     SlpTokenType = 2
	SlpTokenType_V2_GROUP_NFT SlpTokenType = 66
)
...
const (
	...
	// SLP_V2 and SLP_V2_WITH_V1 will be used within the SlpTransactionInfo message
	// that contains slp v2 outputs.  It is possible to have transactions containing
	// both slp v1 and v2, so these can be flagged as such using SLP_V2_WITH_V1.
	SlpAction_SLP_V2         SlpAction = 13
	SlpAction_SLP_V2_WITH_V1 SlpAction = 14
	// op_group related actions used in SlpToken objects
	SlpAction_SLP_V2_SEND_OUTPUT      SlpAction = 15
	SlpAction_SLP_V2_NFT_SEND_OUTPUT  SlpAction = 16
	SlpAction_SLP_V2_AUTHORITY_OUTPUT SlpAction = 17
)
...
var (
	SlpAction_name = map[int32]string{
		...
		13: "SLP_V2",
		14: "SLP_V2_WITH_V1",
		15: "SLP_V2_SEND_OUTPUT",
		16: "SLP_V2_NFT_SEND_OUTPUT",
		17: "SLP_V2_AUTHORITY_OUTPUT",
	}
	SlpAction_value = map[string]int32{
		...
		"SLP_V2":                           13,
		"SLP_V2_WITH_V1":                   14,
		"SLP_V2_SEND_OUTPUT":               15,
		"SLP_V2_NFT_SEND_OUTPUT":           16,
		"SLP_V2_AUTHORITY_OUTPUT":          17,
	}
)
...
// GroupFlags represents the 2-byte group flags embedded as part of the 32-byte group id.
// The enum values are not the protocol flag values.
type GroupFlag int32

const (
	GroupFlag_COVENANT  GroupFlag = 0
	GroupFlag_HOLDS_BCH GroupFlag = 1
)

// Enum value maps for GroupFlag.
var (
	GroupFlag_name = map[int32]string{
		0: "COVENANT",
		1: "HOLDS_BCH",
	}
	GroupFlag_value = map[string]int32{
		"COVENANT":  0,
		"HOLDS_BCH": 1,
	}
)

func (x GroupFlag) Enum() *GroupFlag {
	p := new(GroupFlag)
	*p = x
	return p
}

func (x GroupFlag) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GroupFlag) Descriptor() protoreflect.EnumDescriptor {
	return file_bchrpc_proto_enumTypes[2].Descriptor()
}

func (GroupFlag) Type() protoreflect.EnumType {
	return &file_bchrpc_proto_enumTypes[2]
}

func (x GroupFlag) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GroupFlag.Descriptor instead.
func (GroupFlag) EnumDescriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{2}
}

// GroupAuthorityFlags represents the authority flags in an authority output
// The enum values are not the protocol flag values.
type GroupAuthorityFlag int32

const (
	GroupAuthorityFlag_MINT     GroupAuthorityFlag = 0
	GroupAuthorityFlag_MELT     GroupAuthorityFlag = 1
	GroupAuthorityFlag_BATON    GroupAuthorityFlag = 2
	GroupAuthorityFlag_RESCRIPT GroupAuthorityFlag = 3
	GroupAuthorityFlag_SUBGROUP GroupAuthorityFlag = 4
)

// Enum value maps for GroupAuthorityFlag.
var (
	GroupAuthorityFlag_name = map[int32]string{
		0: "MINT",
		1: "MELT",
		2: "BATON",
		3: "RESCRIPT",
	...
	GroupAuthorityFlag_value = map[string]int32{
		"MINT":     0,
		"MELT":     1,
		"BATON":    2,
		"RESCRIPT": 3,
...
func (x GroupAuthorityFlag) Enum() *GroupAuthorityFlag {
	p := new(GroupAuthorityFlag)
	*p = x
	return p
}

func (x GroupAuthorityFlag) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GroupAuthorityFlag) Descriptor() protoreflect.EnumDescriptor {
	return file_bchrpc_proto_enumTypes[3].Descriptor()
}

func (GroupAuthorityFlag) Type() protoreflect.EnumType {
	return &file_bchrpc_proto_enumTypes[3]
}

func (x GroupAuthorityFlag) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GroupAuthorityFlag.Descriptor instead.
func (GroupAuthorityFlag) EnumDescriptor() ([]byte, []int) {
...
func (BlockNotification_Type) EnumDescriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{42, 0}
}
...
func (TransactionNotification_Type) EnumDescriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{43, 0}
}
...
func (SlpTransactionInfo_ValidityJudgement) EnumDescriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{51, 0}
}
...
func (SlpTransactionInfo_BurnFlags) EnumDescriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{51, 1}
}
...
type SlpToken struct {
	...
	GroupAuthorityFlags []GroupAuthorityFlag `protobuf:"varint,8,rep,packed,name=group_authority_flags,json=groupAuthorityFlags,proto3,enum=pb.GroupAuthorityFlag" json:"group_authority_flags,omitempty"`
	GroupFlags          []GroupFlag          `protobuf:"varint,9,rep,packed,name=group_flags,json=groupFlags,proto3,enum=pb.GroupFlag" json:"group_flags,omitempty"`
}
...
func (x *SlpToken) GetGroupAuthorityFlags() []GroupAuthorityFlag {
	if x != nil {
		return x.GroupAuthorityFlags
	}
	return nil
}

func (x *SlpToken) GetGroupFlags() []GroupFlag {
	if x != nil {
		return x.GroupFlags
	}
	return nil
...
func (x *SlpTokenMetadata) GetV2GroupSpec() *SlpTokenMetadata_V2GroupSpec {
	if x, ok := x.GetTypeMetadata().(*SlpTokenMetadata_V2GroupSpec_); ok {
		return x.V2GroupSpec
	}
	return nil
}
...
type SlpTokenMetadata_V2GroupSpec_ struct {
	// op_group type of metadata
	V2GroupSpec *SlpTokenMetadata_V2GroupSpec `protobuf:"bytes,6,opt,name=v2_group_spec,json=v2GroupSpec,proto3,oneof"`
}
...
func (*SlpTokenMetadata_V2GroupSpec_) isSlpTokenMetadata_TypeMetadata() {}
...
func (*Transaction_Input) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{46, 0}
}
...
func (*Transaction_Output) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{46, 1}
}
...
func (*Transaction_Input_Outpoint) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{46, 0, 0}
}
...
// TokenMetadataV1Fungible is used to marshal metadata specific to Type 1 token IDs
...
func (*SlpTokenMetadata_V1Fungible) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{57, 0}
}
...
// TokenMetadataV1NFT1Group is used to marshal metadata specific to NFT1 Group token IDs
type SlpTokenMetadata_V1NFT1Group struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (*SlpTokenMetadata_V1NFT1Group) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{57, 1}
}
...
// TokenMetadataV1NFT1Child is used to marshal metadata specific to NFT1 Child token IDs
type SlpTokenMetadata_V1NFT1Child struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (*SlpTokenMetadata_V1NFT1Child) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{57, 2}
}
...
// V2GroupSpec is used to marshal metadata specific to op_group version of SLP
type SlpTokenMetadata_V2GroupSpec struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	TokenDocumentHash []byte      `protobuf:"bytes,4,opt,name=token_document_hash,json=tokenDocumentHash,proto3" json:"token_document_hash,omitempty"`
	Decimals          uint32      `protobuf:"varint,5,opt,name=decimals,proto3" json:"decimals,omitempty"`
	ParentGroupId     []byte      `protobuf:"bytes,6,opt,name=parent_group_id,json=parentGroupId,proto3" json:"parent_group_id,omitempty"`
	GroupFlags        []GroupFlag `protobuf:"varint,7,rep,packed,name=group_flags,json=groupFlags,proto3,enum=pb.GroupFlag" json:"group_flags,omitempty"`
}

func (x *SlpTokenMetadata_V2GroupSpec) Reset() {
	*x = SlpTokenMetadata_V2GroupSpec{}
	if protoimpl.UnsafeEnabled {
...
func (x *SlpTokenMetadata_V2GroupSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SlpTokenMetadata_V2GroupSpec) ProtoMessage() {}

func (x *SlpTokenMetadata_V2GroupSpec) ProtoReflect() protoreflect.Message {
	mi := &file_bchrpc_proto_msgTypes[69]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SlpTokenMetadata_V2GroupSpec.ProtoReflect.Descriptor instead.
func (*SlpTokenMetadata_V2GroupSpec) Descriptor() ([]byte, []int) {
	return file_bchrpc_proto_rawDescGZIP(), []int{57, 3}
}

func (x *SlpTokenMetadata_V2GroupSpec) GetTokenTicker() string {
	if x != nil {
		return x.TokenTicker
	}
	return ""
...
func (x *SlpTokenMetadata_V2GroupSpec) GetTokenName() string {
	if x != nil {
		return x.TokenName
	}
	return ""
...
func (x *SlpTokenMetadata_V2GroupSpec) GetTokenDocumentUrl() string {
	if x != nil {
		return x.TokenDocumentUrl
	}
	return ""
...
func (x *SlpTokenMetadata_V2GroupSpec) GetTokenDocumentHash() []byte {
	if x != nil {
		return x.TokenDocumentHash
	}
	return nil
...
func (x *SlpTokenMetadata_V2GroupSpec) GetDecimals() uint32 {
	if x != nil {
		return x.Decimals
	}
	return 0
...
func (x *SlpTokenMetadata_V2GroupSpec) GetParentGroupId() []byte {
	if x != nil {
...
func (x *SlpTokenMetadata_V2GroupSpec) GetGroupFlags() []GroupFlag {
	if x != nil {
		return x.GroupFlags
	}
	return nil
...
var file_bchrpc_proto_rawDesc = []byte{
	...
	0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x88, 0x01,
	...
	0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3b, 0x0a, 0x0e, 0x74,
	...
	0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x2e, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x52,
	...
	0x28, 0x0c, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x3d, 0x0a, 0x19, 0x47, 0x65, 0x74, 0x52,
	...
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xac, 0x01, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x41,
	...
	0x65, 0x73, 0x73, 0x12, 0x17, 0x0a, 0x07, 0x6e, 0x62, 0x5f, 0x73, 0x6b, 0x69, 0x70, 0x18, 0x02,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0e, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x4d, 0x65,
	0x6d, 0x70, 0x6f, 0x6f, 0x6c, 0x12, 0x34, 0x0a, 0x16, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65,
	0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x14, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x8c, 0x01, 0x0a, 0x20,
	...
	0x74, 0x70, 0x75, 0x74, 0x52, 0x07, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x12, 0x3b, 0x0a,
	0x0e, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x6c, 0x70, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x0d, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa2, 0x01, 0x0a, 0x17, 0x47,
	...
	,
	...
	,
	...
	0x42, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4d, 0x65, 0x72, 0x6b, 0x6c, 0x65, 0x50, 0x72, 0x6f, 0x6f,
	0x66, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x29, 0x0a, 0x10, 0x74, 0x72, 0x61, 0x6e,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0xc0, 0x01, 0x0a, 0x1a, 0x43,
	...
	,
	...
	0x0d, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x22, 0x82,
	...
	,
	...
	,
	...
	0x6c, 0x69, 0x64, 0x69, 0x74, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x52, 0x07, 0x72, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x73, 0x1a, 0xe8, 0x02, 0x0a, 0x0e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x69,
	0x74, 0x79, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x22, 0x0a, 0x0d, 0x70, 0x72, 0x65, 0x76,
	0x5f, 0x6f, 0x75, 0x74, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52,
	0x0b, 0x70, 0x72, 0x65, 0x76, 0x4f, 0x75, 0x74, 0x48, 0x61, 0x73, 0x68, 0x12, 0x22, 0x0a, 0x0d,
	0x70, 0x72, 0x65, 0x76, 0x5f, 0x6f, 0x75, 0x74, 0x5f, 0x76, 0x6f, 0x75, 0x74, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0b, 0x70, 0x72, 0x65, 0x76, 0x4f, 0x75, 0x74, 0x56, 0x6f, 0x75, 0x74,
	...
	0x6c, 0x70, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x65, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e,
	0x70, 0x62, 0x2e, 0x53, 0x6c, 0x70, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x52,
	0x09, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x2c, 0x0a, 0x0f, 0x76, 0x31,
	0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x04, 0x42, 0x02, 0x30, 0x01, 0x48, 0x00, 0x52, 0x0d, 0x76, 0x31, 0x54, 0x6f, 0x6b,
	0x65, 0x6e, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x24, 0x0a, 0x0d, 0x76, 0x31, 0x5f, 0x6d,
	0x69, 0x6e, 0x74, 0x5f, 0x62, 0x61, 0x74, 0x6f, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x48,
	...
	,
	...
	,
	...
	0x70, 0x72, 0x65, 0x76, 0x69, 0x6f, 0x75, 0x73, 0x5f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0
x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x20, 0x2e, 0x70, 0x62, 0x2e, 0x53, 0x75, 0x62, 0x73, 0x63,
	...
	,
}
...
var file_bchrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 70)
var file_bchrpc_proto_goTypes = []interface{}{
	(SlpTokenType)(0),                                      // 0: pb.SlpTokenType
	(SlpAction)(0),                                         // 1: pb.SlpAction
	(GroupFlag)(0),                                         // 2: pb.GroupFlag
	(GroupAuthorityFlag)(0),                                // 3: pb.GroupAuthorityFlag
	(GetBlockchainInfoResponse_BitcoinNet)(0),              // 4: pb.GetBlockchainInfoResponse.BitcoinNet
	...
	(*CheckSlpTransactionRequest)(nil),                     // 41: pb.CheckSlpTransactionRequest
	(*CheckSlpTransactionResponse)(nil),                    // 42: pb.CheckSlpTransactionResponse
	(*SubscribeTransactionsRequest)(nil),                   // 43: pb.SubscribeTransactionsRequest
	(*SubscribeBlocksRequest)(nil),                         // 44: pb.SubscribeBlocksRequest
	(*GetSlpTokenMetadataRequest)(nil),                     // 45: pb.GetSlpTokenMetadataRequest
	(*GetSlpTokenMetadataResponse)(nil),                    // 46: pb.GetSlpTokenMetadataResponse
	(*GetSlpParsedScriptRequest)(nil),                      // 47: pb.GetSlpParsedScriptRequest
	(*GetSlpParsedScriptResponse)(nil),                     // 48: pb.GetSlpParsedScriptResponse
	(*GetSlpTrustedValidationRequest)(nil),                 // 49: pb.GetSlpTrustedValidationRequest
	(*GetSlpTrustedValidationResponse)(nil),                // 50: pb.GetSlpTrustedValidationResponse
	...
	(*SlpTokenMetadata_V2GroupSpec)(nil),                   // 78: pb.SlpTokenMetadata.V2GroupSpec
}
var file_bchrpc_proto_depIdxs = []int32{
	...
	4,  // 1: pb.GetBlockchainInfoResponse.bitcoin_net:type_name -> pb.GetBlockchainInfoResponse.BitcoinNet
	...
	5,  // 29: pb.BlockNotification.type:type_name -> pb.BlockNotification.Type
	...
	6,  // 32: pb.TransactionNotification.type:type_name -> pb.TransactionNotification.Type
	...
	3,  // 46: pb.SlpToken.group_authority_flags:type_name -> pb.GroupAuthorityFlag
	2,  // 47: pb.SlpToken.group_flags:type_name -> pb.GroupFlag
	1,  // 48: pb.SlpTransactionInfo.slp_action:type_name -> pb.SlpAction
	7,  // 49: pb.SlpTransactionInfo.validity_judgement:type_name -> pb.SlpTransactionInfo.ValidityJudgement
	8,  // 50: pb.SlpTransactionInfo.burn_flags:type_name -> pb.SlpTransactionInfo.BurnFlags
	61, // 51: pb.SlpTransactionInfo.v1_genesis:type_name -> pb.SlpV1GenesisMetadata
	62, // 52: pb.SlpTransactionInfo.v1_mint:type_name -> pb.SlpV1MintMetadata
	63, // 53: pb.SlpTransactionInfo.v1_send:type_name -> pb.SlpV1SendMetadata
	64, // 54: pb.SlpTransactionInfo.v1_nft1_child_genesis:type_name -> pb.SlpV1Nft1ChildGenesisMetadata
	65, // 55: pb.SlpTransactionInfo.v1_nft1_child_send:type_name -> pb.SlpV1Nft1ChildSendMetadata
	0,  // 56: pb.SlpTokenMetadata.token_type:type_name -> pb.SlpTokenType
	75, // 57: pb.SlpTokenMetadata.v1_fungible:type_name -> pb.SlpTokenMetadata.V1Fungible
	76, // 58: pb.SlpTokenMetadata.v1_nft1_group:type_name -> pb.SlpTokenMetadata.V1NFT1Group
	77, // 59: pb.SlpTokenMetadata.v1_nft1_child:type_name -> pb.SlpTokenMetadata.V1NFT1Child
	78, // 60: pb.SlpTokenMetadata.v2_group_spec:type_name -> pb.SlpTokenMetadata.V2GroupSpec
	74, // 61: pb.SlpRequiredBurn.outpoint:type_name -> pb.Transaction.Input.Outpoint
	0,  // 62: pb.SlpRequiredBurn.token_type:type_name -> pb.SlpTokenType
	55, // 63: pb.GetMempoolResponse.TransactionData.transaction:type_name -> pb.Transaction
	...
	55, // 66: pb.Block.TransactionData.transaction:type_name -> pb.Transaction
	74, // 67: pb.Transaction.Input.outpoint:type_name -> pb.Transaction.Input.Outpoint
	59, // 68: pb.Transaction.Input.slp_token:type_name -> pb.SlpToken
	59, // 69: pb.Transaction.Output.slp_token:type_name -> pb.SlpToken
	2,  // 70: pb.SlpTokenMetadata.V2GroupSpec.group_flags:type_name -> pb.GroupFlag
	9,  // 71: pb.bchrpc.GetMempoolInfo:input_type -> pb.GetMempoolInfoRequest
	11, // 72: pb.bchrpc.GetMempool:input_type -> pb.GetMempoolRequest
	13, // 73: pb.bchrpc.GetBlockchainInfo:input_type -> pb.GetBlockchainInfoRequest
	15, // 74: pb.bchrpc.GetBlockInfo:input_type -> pb.GetBlockInfoRequest
	17, // 75: pb.bchrpc.GetBlock:input_type -> pb.GetBlockRequest
	19, // 76: pb.bchrpc.GetRawBlock:input_type -> pb.GetRawBlockRequest
	21, // 77: pb.bchrpc.GetBlockFilter:input_type -> pb.GetBlockFilterRequest
	23, // 78: pb.bchrpc.GetHeaders:input_type -> pb.GetHeadersRequest
	25, // 79: pb.bchrpc.GetTransaction:input_type -> pb.GetTransactionRequest
	27, // 80: pb.bchrpc.GetRawTransaction:input_type -> pb.GetRawTransactionRequest
	29, // 81: pb.bchrpc.GetAddressTransactions:input_type -> pb.GetAddressTransactionsRequest
	31, // 82: pb.bchrpc.GetRawAddressTransactions:input_type -> pb.GetRawAddressTransactionsRequest
	33, // 83: pb.bchrpc.GetAddressUnspentOutputs:input_type -> pb.GetAddressUnspentOutputsRequest
	35, // 84: pb.bchrpc.GetUnspentOutput:input_type -> pb.GetUnspentOutputRequest
	37, // 85: pb.bchrpc.GetMerkleProof:input_type -> pb.GetMerkleProofRequest
	45, // 86: pb.bchrpc.GetSlpTokenMetadata:input_type -> pb.GetSlpTokenMetadataRequest
	47, // 87: pb.bchrpc.GetSlpParsedScript:input_type -> pb.GetSlpParsedScriptRequest
	49, // 88: pb.bchrpc.GetSlpTrustedValidation:input_type -> pb.GetSlpTrustedValidationRequest
	41, // 89: pb.bchrpc.CheckSlpTransaction:input_type -> pb.CheckSlpTransactionRequest
	39, // 90: pb.bchrpc.SubmitTransaction:input_type -> pb.SubmitTransactionRequest
	43, // 91: pb.bchrpc.SubscribeTransactions:input_type -> pb.SubscribeTransactionsRequest
	43, // 92: pb.bchrpc.SubscribeTransactionStream:input_type -> pb.SubscribeTransactionsRequest
	44, // 93: pb.bchrpc.SubscribeBlocks:input_type -> pb.SubscribeBlocksRequest
	10, // 94: pb.bchrpc.GetMempoolInfo:output_type -> pb.GetMempoolInfoResponse
	12, // 95: pb.bchrpc.GetMempool:output_type -> pb.GetMempoolResponse
	14, // 96: pb.bchrpc.GetBlockchainInfo:output_type -> pb.GetBlockchainInfoResponse
	16, // 97: pb.bchrpc.GetBlockInfo:output_type -> pb.GetBlockInfoResponse
	18, // 98: pb.bchrpc.GetBlock:output_type -> pb.GetBlockResponse
	20, // 99: pb.bchrpc.GetRawBlock:output_type -> pb.GetRawBlockResponse
	22, // 100: pb.bchrpc.GetBlockFilter:output_type -> pb.GetBlockFilterResponse
	24, // 101: pb.bchrpc.GetHeaders:output_type -> pb.GetHeadersResponse
	26, // 102: pb.bchrpc.GetTransaction:output_type -> pb.GetTransactionResponse
	28, // 103: pb.bchrpc.GetRawTransaction:output_type -> pb.GetRawTransactionResponse
	30, // 104: pb.bchrpc.GetAddressTransactions:output_type -> pb.GetAddressTransactionsResponse
	32, // 105: pb.bchrpc.GetRawAddressTransactions:output_type -> pb.GetRawAddressTransactionsResponse
	34, // 106: pb.bchrpc.GetAddressUnspentOutputs:output_type -> pb.GetAddressUnspentOutputsResponse
	36, // 107: pb.bchrpc.GetUnspentOutput:output_type -> pb.GetUnspentOutputResponse
	38, // 108: pb.bchrpc.GetMerkleProof:output_type -> pb.GetMerkleProofResponse
	46, // 109: pb.bchrpc.GetSlpTokenMetadata:output_type -> pb.GetSlpTokenMetadataResponse
	48, // 110: pb.bchrpc.GetSlpParsedScript:output_type -> pb.GetSlpParsedScriptResponse
	50, // 111: pb.bchrpc.GetSlpTrustedValidation:output_type -> pb.GetSlpTrustedValidationResponse
	42, // 112: pb.bchrpc.CheckSlpTransaction:output_type -> pb.CheckSlpTransactionResponse
	40, // 113: pb.bchrpc.SubmitTransaction:output_type -> pb.SubmitTransactionResponse
	52, // 114: pb.bchrpc.SubscribeTransactions:output_type -> pb.TransactionNotification
	52, // 115: pb.bchrpc.SubscribeTransactionStream:output_type -> pb.TransactionNotification
	51, // 116: pb.bchrpc.SubscribeBlocks:output_type -> pb.BlockNotification
...
func file_bchrpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_bchrpc_proto_msgTypes[69].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SlpTokenMetadata_V2GroupSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_bchrpc_proto_msgTypes[51].OneofWrappers = []interface{}{
	...
	file_bchrpc_proto_msgTypes[57].OneofWrappers = []interface{}{
		(*SlpTokenMetadata_V1Fungible_)(nil),
		(*SlpTokenMetadata_V1Nft1Group)(nil),
		(*SlpTokenMetadata_V1Nft1Child)(nil),
		(*SlpTokenMetadata_V2GroupSpec_)(nil),
	}
	file_bchrpc_proto_msgTypes[58].OneofWrappers = []interface{}{
